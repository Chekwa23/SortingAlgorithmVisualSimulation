...
//			{
////				translate(arrTemp.get(j-1).index,cursor.index);
//				translate(arrTemp.get(j-1),cursor);
//				arrTemp.set(j, arrTemp.get(j-1));
//				arrTemp.set(j-1, cursor);
//			}
//		}
...
//	double time = 0.1;
////	double time = 5;
//	public void translate(Triple present, Triple next)
//	{
//		int moveBy = next.distance - present.distance;
//		TranslateTransition trans = new TranslateTransition(Duration.seconds(time), rectList.get(present.index));
//		trans.setByX(moveBy);
//		present.distance += moveBy;
//		transList.add(trans);
//		TranslateTransition trans1 = new TranslateTransition(Duration.seconds(time), rectList.get(next.index));
//		trans1.setByX(moveBy);
//		next.distance += moveBy;
//		transList.add(trans1);
//	}
//	
//	
